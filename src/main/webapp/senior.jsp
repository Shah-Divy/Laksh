...
<body>
    ...
    <main>
            <%
      ResultSet retriveProduct= DBconnection.getResultFromSqlQuery("select *from post_job where type='CE' ");
            ...
            <div class="job__Wrapper-hinme4-2 eAkeWf">
                <div class="styles__Container-sc-15yd6lj-9 hFsuF">
                    <div class="styles__Wrapper-sc-15yd6lj-0 SPmfS">
                        ...
                        <div
                            class="styles_TextHeadingContainer-sc-15yd6lj-1 styles_TextSalaryContainer-sc-15yd6lj-3 kNZsEd jyJyXA">
