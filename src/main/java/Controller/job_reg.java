 ...
 * @author divys
 */
@WebServlet(name = "job_reg", urlPatterns = {"/job_reg"})
public class job_reg extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       try  {
		...
		PreparedStatement st = con.prepareStatement("insert into company values(?,?,?,?,?)");
...
HttpSession session = request.getSession();
		...
		PrintWriter out = response.getWriter();
                RequestDispatcher rd=request.getRequestDispatcher("mailJserverlet");  
